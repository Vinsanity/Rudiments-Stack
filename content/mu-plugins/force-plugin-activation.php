...
class Force_Plugin_Activation {
	...
	private $force_active = array(
		'threefive-support/threefive-support.php',
		'threefive-security/threefive-security.php',
	);

	/**
	 * These plugins will be deactive and can't be activated (if WP_DEBUG is false)
	 *
	 * Add elements as plugin path: directory/file.php
	 */
